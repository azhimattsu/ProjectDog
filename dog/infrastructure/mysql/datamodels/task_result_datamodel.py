...
class TaskResultDataModel(Base):
    ...
    def import_entity(self, id: wbs.TaskId, entity: wbs.TaskResult):
...
def from_entity(id: wbs.TaskId, entity: wbs.TaskResult) -> TaskResultDataModel:
    target = TaskResultDataModel()
